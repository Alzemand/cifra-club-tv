...
{
    public class MPBSambaBossaNovaViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("MPBSambaBossaNovaDetail", item);
                        });
                }
        ...
        {
            return new MPBSambaBossaNovaDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("MPBSambaBossaNovaList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("MPBSambaBossaNovaDetail");
        }
