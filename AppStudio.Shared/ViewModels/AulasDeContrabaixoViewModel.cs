...
{
    public class AulasDeContrabaixoViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("AulasDeContrabaixoDetail", item);
                        });
                }
        ...
        {
            return new AulasDeContrabaixoDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("AulasDeContrabaixoList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("AulasDeContrabaixoDetail");
        }
