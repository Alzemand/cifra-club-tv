...
{
    public class TeoriasEDicasViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TeoriasEDicasDetail", item);
                        });
                }
        ...
        {
            return new TeoriasEDicasDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TeoriasEDicasList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TeoriasEDicasDetail");
        }
