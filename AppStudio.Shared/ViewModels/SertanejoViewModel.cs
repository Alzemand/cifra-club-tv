...
{
    public class SertanejoViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("SertanejoDetail", item);
                        });
                }
        ...
        {
            return new SertanejoDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("SertanejoList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("SertanejoDetail");
        }
