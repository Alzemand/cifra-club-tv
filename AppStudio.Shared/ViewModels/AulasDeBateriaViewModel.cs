...
{
    public class AulasDeBateriaViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("AulasDeBateriaDetail", item);
                        });
                }
        ...
        {
            return new AulasDeBateriaDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("AulasDeBateriaList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("AulasDeBateriaDetail");
        }
