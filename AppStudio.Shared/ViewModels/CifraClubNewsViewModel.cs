...
{
    public class CifraClubNewsViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("CifraClubNewsDetail", item);
                        });
                }
        ...
        {
            return new CifraClubNewsDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("CifraClubNewsList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("CifraClubNewsDetail");
        }
    }
}
