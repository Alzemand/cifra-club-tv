...
{
    public class RockViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("RockDetail", item);
                        });
                }
        ...
        {
            return new RockDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("RockList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("RockDetail");
        }
