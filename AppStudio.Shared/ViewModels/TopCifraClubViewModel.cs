...
{
    public class TopCifraClubViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TopCifraClubDetail", item);
                        });
                }
        ...
        {
            return new TopCifraClubDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TopCifraClubList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TopCifraClubDetail");
        }
