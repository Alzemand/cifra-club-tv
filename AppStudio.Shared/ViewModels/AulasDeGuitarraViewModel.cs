...
{
    public class AulasDeGuitarraViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("AulasDeGuitarraDetail", item);
                        });
                }
        ...
        {
            return new AulasDeGuitarraDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("AulasDeGuitarraList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("AulasDeGuitarraDetail");
        }
