...
{
    public class AulasIntermediariasViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("AulasIntermediariasDetail", item);
                        });
                }
        ...
        {
            return new AulasIntermediariasDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("AulasIntermediariasList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("AulasIntermediariasDetail");
        }
