...
{
    public class AulasAvancadasViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("AulasAvancadasDetail", item);
                        });
                }
        ...
        {
            return new AulasAvancadasDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("AulasAvancadasList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("AulasAvancadasDetail");
        }
