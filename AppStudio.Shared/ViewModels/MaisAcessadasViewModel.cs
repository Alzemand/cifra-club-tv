...
{
    public class MaisAcessadasViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("MaisAcessadasDetail", item);
                        });
                }
        ...
        {
            return new MaisAcessadasDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("MaisAcessadasList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("MaisAcessadasDetail");
        }
