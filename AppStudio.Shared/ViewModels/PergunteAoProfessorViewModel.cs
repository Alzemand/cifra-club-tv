...
{
    public class PergunteAoProfessorViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("PergunteAoProfessorDetail", item);
                        });
                }
        ...
        {
            return new PergunteAoProfessorDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("PergunteAoProfessorList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("PergunteAoProfessorDetail");
        }
