...
namespace AppStudio
{
    ...
    {
        private Guid APP_ID = new Guid("4f0c1f72-c4a9-4fc6-878b-815af533368b");
        public const string APP_NAME = "Cifra Club TV";
        ...
        {
            TileServices.CreateFlipTile(@"Novas Vídeo Aulas", @"");
        }
        #endregion
    }
}
