...
{
    public sealed partial class AulasAvancadasDetail : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (AulasAvancadasModel != null)
            {
                ...
                AulasAvancadasModel.SelectItem(e.Parameter);

                AulasAvancadasModel.ViewType = ViewTypes.Detail;
            }
