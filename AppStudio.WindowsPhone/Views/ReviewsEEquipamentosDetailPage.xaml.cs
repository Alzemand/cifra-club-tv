...
{
    public sealed partial class ReviewsEEquipamentosDetail : Page
    {
        ...
        public ReviewsEEquipamentosDetail()
        {
            ...
            ReviewsEEquipamentosModel = new ReviewsEEquipamentosViewModel();
        ...
        public ReviewsEEquipamentosViewModel ReviewsEEquipamentosModel { get; private set; }
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (ReviewsEEquipamentosModel != null)
            {
                await ReviewsEEquipamentosModel.LoadItemsAsync();
                ReviewsEEquipamentosModel.SelectItem(e.Parameter);

                ReviewsEEquipamentosModel.ViewType = ViewTypes.Detail;
            }
        ...
        private void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            if (ReviewsEEquipamentosModel != null)
            {
                ReviewsEEquipamentosModel.GetShareContent(args.Request);
            }
        }
